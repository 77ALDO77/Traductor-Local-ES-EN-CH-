...
if ! docker exec boc_translator_ollama_v1 ollama list | grep -q "qwen2.5:7b"; then
    echo "   Descargando Qwen2.5:7b (~4GB)..."
    docker exec boc_translator_ollama_v1 ollama pull qwen2.5:7b
    echo "✅ Qwen2.5:7b descargado"
else
    echo "✅ Qwen2.5:7b ya existe"
fi
